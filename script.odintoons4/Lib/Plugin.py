...
USER_AGENT = 'CTOONKodi/' + ADDON_VERSION + ' (JSON API; +https://github.com/doko-desuka/script.odintoons4)'
...
def notification(message, delay=3000, useSound=True):
    xbmcgui.Dialog().notification('Odin toons 4', message, xbmcgui.NOTIFICATION_INFO, delay, useSound)
