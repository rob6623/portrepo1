...
import urlparse,sys,urllib,json,xbmc,os,xbmcaddon,xbmcgui
...
if action == None:
    ...
    movies.movies().screamq()

elif action == 'namegenre':
    from resources.lib.indexers import movies
    movies.movies().namegenre()
...
elif action == 'arkhamscrapersettings'    : xbmcaddon.Addon('script.module.universalscrapers').openSettings()