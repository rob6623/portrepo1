...
def metaFile():
    if condVisibility('System.HasAddon(script.ANARKY.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.ANARKY.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
