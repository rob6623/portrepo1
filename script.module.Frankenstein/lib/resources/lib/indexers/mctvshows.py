...
class tvshows:
    def __init__(self):
        ...
        self.genre50_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1960-12-31&title_type=tv_series,mini_series&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre60_link = 'http://www.imdb.com/search/title?release_date=1960-01-01,1970-12-31&title_type=tv_series,mini_series&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre70_link = 'http://www.imdb.com/search/title?release_date=1970-01-01,1980-12-31&title_type=tv_series,mini_series&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre80_link = 'http://www.imdb.com/search/title?release_date=1980-01-01,1990-12-31&title_type=tv_series,mini_series&genres=%s&sort=moviemeter,asc&count=40&start=1'
