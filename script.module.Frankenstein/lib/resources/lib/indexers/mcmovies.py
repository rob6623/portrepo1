...
class movies:
    def __init__(self):
        ...
        self.genre50_link = 'https://www.imdb.com/search/title?release_date=1950-01-01,1959-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre60_link = 'http://www.imdb.com/search/title?release_date=1960-01-01,1970-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&genres=%s&sort=moviemeter,asc&count=40&start=1'		
        self.genre70_link = 'http://www.imdb.com/search/title?release_date=1970-01-01,1980-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&genres=%s&sort=moviemeter,asc&count=40&start=1'		
        self.genre80_link = 'http://www.imdb.com/search/title?release_date=1980-01-01,1998-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&genres=%s&sort=moviemeter,asc&count=40&start=1'		
