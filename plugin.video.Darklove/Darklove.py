...
if action == None:
    ...
    movies.movies().genresdrama()
	
elif action == 'movieGenresrom':
    from resources.lib.indexers import movies
    movies.movies().genresrom()
    ...
    from resources.lib.indexers import movies
    movies.movies().languagesdrama()

elif action == 'movieLanguagesrom':
    from resources.lib.indexers import movies
    movies.movies().languagesrom()

elif action == 'movieCertificatesdrama':
    from resources.lib.indexers import movies
    movies.movies().certificationsdrama()

elif action == 'movieCertificatesrom':
    from resources.lib.indexers import movies
    movies.movies().certificationsrom()

elif action == 'movieYearsdrama':
    from resources.lib.indexers import movies
    movies.movies().yearsdrama()

elif action == 'movieYearsrom':
    from resources.lib.indexers import movies
    movies.movies().yearsrom()
    ...
    tvshows.tvshows().yearsdrama()

elif action == 'tvYearsrom':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().yearsrom()

elif action == 'tvGenresdrama':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genresdrama()

elif action == 'tvGenresrom':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genresrom()

elif action == 'tvLanguagesdrama':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().languagesdrama()

elif action == 'tvLanguagesrom':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().languagesrom()

elif action == 'tvCertificatesdrama':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().certificationsdrama()

elif action == 'tvCertificatesrom':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().certificationsrom()
