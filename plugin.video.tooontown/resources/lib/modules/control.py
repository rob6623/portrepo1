...
def metaFile():
    if condVisibility('System.HasAddon(script.AnArchy.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.AnArchy.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
