...
class tvshows:
    def __init__(self):
        ...
        self.animepopular_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&keywords=anime&num_votes=1000,&production_status=released&groups=top_1000&sort=moviemeter,asc&count=40&start=1'
        ...
        self.animeviews_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&keywords=anime&num_votes=1000,&production_status=released&sort=num_votes,desc&count=40&start=1'
        self.animerating_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&keywords=anime&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        ...
        self.animeactive_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=10,&production_status=active&sort=moviemeter,asc&count=40&start=1'
        self.animeairing_link = 'http://www.imdb.com/search/title?title_type=tv_episode&keywords=anime&release_date=date[1],date[0]&sort=moviemeter,asc&count=40&start=1'
        self.animepopular_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&keywords=anime&sort=moviemeter,asc&count=40&start=1'

        self.persons_link = 'http://www.imdb.com/search/name?count=100&name='
        self.personlist_link = 'http://www.imdb.com/search/name?count=100&gender=male,female'
        self.popular_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=100,&release_date=,date[0]&genres=animation&sort=moviemeter,asc&count=40&start=1'
        self.airing_link = 'http://www.imdb.com/search/title?title_type=tv_episode&genres=animation&release_date=date[1],date[0]&sort=moviemeter,asc&count=40&start=1'
        self.active_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=10,&production_status=active&sort=moviemeter,asc&count=40&start=1'
        self.premiere_link = 'http://www.imdb.com/search/title?title_type=tv_series,tv_special,tv_miniseries&genres=animation&languages=en&num_votes=10,&release_date=date[60],date[0]sort=alpha,asc'
        self.rating_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        self.views_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count=40&start=1'
        ...
        self.genre_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=animation,%s&sort=moviemeter,asc&count=40&start=1&sort=alpha,asc'
        ...
        self.keyword_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&release_date=,date[0]&keywords=%s&sort=moviemeter,asc&count=40&start=1'
        self.language_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=100,&production_status=released&primary_language=%s&sort=moviemeter,asc&count=40&start=1'
        self.certification_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&release_date=,date[0]&certificates=us:%s&sort=moviemeter,asc&count=40&start=1'
        ...
        self.anime_link = 'http://www.imdb.com/search/title?title_type=tv_series&genres=animation&keywords=anime'			
        self.year_link = 'http://www.imdb.com/search/title?title_type=tv_series,tv_special,tv_miniseries&production_status=released&genres=animation&year=%s,%s&sort=moviemeter,asc&count=40&start=1&languages=en'
        self.STARTREK_link = 'http://www.imdb.com/list/ls021175534?sort=release_date&mode=detail&page=1'
    ...
    def animecertifications(self):
        ...
        for i in certificates: self.list.append({'name': str(i), 'url': self.animecertification_link % str(i).replace('-', '_').lower(), 'image': 'certificates.jpg', 'action': 'tvshows'})
    ...
    def animeyears(self):
        ...
        for i in range(int(year)-0, 1950, -1): self.list.append({'name': str(i), 'url': self.animeyear_link % (str(i), str(i)), 'image': 'years.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list		
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1950, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'years.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
    ...
    def genres(self):
        genres = [
            ('Animation Action', 'action', True),
            ('Animation Adventure', 'adventure', True),
            ('Animation Biography', 'biography', True),
            ('Animation Comedy', 'comedy', True),
            ('Animation Crime', 'crime', True),
            ('Animation Drama', 'drama', True),
            ('Animation Family', 'family', True),
            ('Animation Fantasy', 'fantasy', True),
            ('Animation Game-Show', 'game_show', True),
            ('Animation History', 'history', True),
            ('Animation Music ', 'music', True),
            ('Animation Mystery', 'mystery', True),
            ('Animation Reality-TV', 'reality_tv', True),
            ('Animation Romance', 'romance', True),
            ('Animation Science Fiction', 'sci_fi', True),
            ('Animation Talk-Show', 'talk_show', True),
            ('Animation Thriller', 'thriller', True),
            ('Animation War', 'war', True),
            ('Animation Western', 'western', True)
    ...
    def languages(self):
        ...
        for i in languages: self.list.append({'name': str(i[0]), 'url': self.language_link % i[1], 'image': 'languages.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
