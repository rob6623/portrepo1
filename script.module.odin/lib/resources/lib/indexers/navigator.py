...
class navigator:
    ...
    def lists(self, lite=False):
        self.addDirectoryItem('movie indexes', 'lists', 'index.png', 'DefaultTVShows.png')
        self.addDirectoryItem('tv show indexes', 'lists2', 'index.png', 'DefaultTVShows.png')
        self.addDirectoryItem('xxx adults only', 'lists3', 'xxx.png', 'DefaultTVShows.png')
        self.endDirectory()

    def tns(self, lite=False):
        self.addDirectoryItem('Sports', 'lists4', 'sports.png', 'DefaultTVShows.png')
