...
def get_movie_metadata(movie, genres_dict=None):
    ...
    else: info['poster'] = "http://reaperslockedmadhouse/hellspitthemes/themes/Style/unavailable.png"
...
def item_images(type, tmdb_id=None, imdb_id=None, tvdb_id=None, name=None):
    ...
    if isinstance(response, dict):
        ...
        else                            : poster = "http://reaperslockedmadhouse/hellspitthemes/themes/Style/unavailable.png"
