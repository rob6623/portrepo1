...
class tvshows:
    def __init__(self):
        ...
        self.popular_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&genres=horror&sort=moviemeter,asc&count=40&start=1'
        ...
        self.premiere_link = 'http://www.imdb.com/search/title?title_type=tv_series,tv_special,tv_miniseries&genres=horror&languages=en&num_votes=10,&release_date=date[60],date[0]sort=alpha,asc'
        self.rating_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=horror&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        self.views_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=horror&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count=40&start=1'
        ...
        self.certification_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=horror&release_date=,date[0]&certificates=us:%s&sort=moviemeter,asc&count=40&start=1'
        ...
        self.anime_link = 'http://www.imdb.com/search/title?title_type=tv_series&genres=horror&keywords=anime'			
        self.year_link = 'http://www.imdb.com/search/title?title_type=tv_series,tv_special,tv_miniseries&production_status=released&genres=horror&year=%s,%s&sort=moviemeter,asc&count=40&start=1&languages=en'
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1970, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'years.jpg', 'action': 'tvshows'})
