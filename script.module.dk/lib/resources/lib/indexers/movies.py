...
#        `=}--{='     `=}--{='
#       .-^--r-^-.   .-^--r-^-.
# Dark Carnival is futile @lock_down... 
...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'https://www.imdb.com/movies-in-theaters/?ref_=nv_mv_inth'
...
##################################################################### freakshow ######################################################
        self.can_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&keywords=cannibal&count=40&start=41&ref_=adv_nxt'
        self.drugs_link = 'https://www.imdb.com/search/keyword?keywords=drugs&ref_=kw_ref_typ&sort=year,asc&mode=detail&page=1&title_type=movie'
        self.freaks_link = 'https://www.imdb.com/search/keyword?keywords=freak&ref_=kw_ref_typ&sort=year,asc&mode=detail&page=1&title_type=movie'
        self.circus_link = 'https://www.imdb.com/search/keyword?keywords=circus&ref_=kw_ref_key&mode=detail&page=1&title_type=movie&sort=year,asc'
