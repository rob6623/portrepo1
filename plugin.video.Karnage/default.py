...
if action == None:
    ...
    from resources.lib.indexers import Karnage
    Karnage.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import Karnage
    Karnage.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import Karnage
    Karnage.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import Karnage
    Karnage.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import Karnage
    Karnage.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import Karnage
    Karnage.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import Karnage
    Karnage.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import Karnage
    Karnage.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import Karnage
    Karnage.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import Karnage
    Karnage.indexer().delSearch()
