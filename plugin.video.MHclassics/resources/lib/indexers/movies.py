...
class movies:
    def __init__(self):
        ...
        self.genre50_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1960-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre60_link = 'http://www.imdb.com/search/title?release_date=1960-01-01,1970-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'		
        self.genre70_link = 'http://www.imdb.com/search/title?release_date=1970-01-01,1980-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'		
        self.genre80_link = 'http://www.imdb.com/search/title?release_date=1980-01-01,1998-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'		
        ...
        self.popular_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=1000,&production_status=released&groups=top_1000&sort=moviemeter,asc&count=40&start=1'
        self.views_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=1000,&production_status=released&sort=num_votes,desc&count=40&start=1'
        self.featured_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=1000,&production_status=released&release_date=date[365],date[60]&sort=moviemeter,asc&count=40&start=1'
        self.person_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&production_status=released&role=%s&sort=year,desc&count=40&start=1'
        self.keyword_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&keywords=%s&sort=moviemeter,asc&count=40&start=1'
        self.language_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=100,&production_status=released&primary_language=%s&sort=moviemeter,asc&count=40&start=1'
        self.certification_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=100,&production_status=released&certificates=us:%s&sort=moviemeter,asc&count=40&start=1'
        self.year_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
        self.boxoffice_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&production_status=released&sort=boxoffice_gross_us,desc&count=40&start=1'
        self.oscars_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature,tv_movie&production_status=released&groups=oscar_best_picture_winners&sort=year,desc&count=40&start=1'
        self.theaters_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=feature&num_votes=1000,&release_date=date[365],date[0]&sort=release_date_us,desc&count=40&start=1'
        ...
        for i in genres: self.list.append(
            {
                ...
                'url': self.genre50_link % i[1] if i[2] else self.keyword_link % i[1],
                'image': 'movies.jpg',
                'action': 'movies'
            })
    ...
    def genres60(self):
        ...
        for i in genres: self.list.append(
            {
                'name': cleangenre.lang(i[0], self.lang),
                'url': self.genre60_link % i[1] if i[2] else self.keyword_link % i[1],
                'image': 'movies.jpg',
                'action': 'movies'
            })
    ...
    def genres70(self):
        ...
        for i in genres: self.list.append(
            {
                'name': cleangenre.lang(i[0], self.lang),
                'url': self.genre70_link % i[1] if i[2] else self.keyword_link % i[1],
                'image': 'movies.jpg',
                'action': 'movies'
            })
    ...
    def genres80(self):
        ...
        for i in genres: self.list.append(
            {
                'name': cleangenre.lang(i[0], self.lang),
                'url': self.genre80_link % i[1] if i[2] else self.keyword_link % i[1],
                'image': 'movies.jpg',
                'action': 'movies'
            })
