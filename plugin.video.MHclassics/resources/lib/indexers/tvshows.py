...
class tvshows:
    def __init__(self):
        ...
        self.popular_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&sort=moviemeter,asc&count=40&start=1'
        self.airing_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_episode&release_date=date[1],date[0]&sort=moviemeter,asc&count=40&start=1'
        self.active_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&num_votes=10,&production_status=active&sort=moviemeter,asc&count=40&start=1'
        self.premiere_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&languages=en&num_votes=10,&release_date=date[60],date[0]&sort=moviemeter,asc&count=40&start=1'
        self.rating_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        self.views_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count=40&start=1'
        ...
        self.genre50_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1960-12-31&title_type=tv_series,mini_series&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre60_link = 'http://www.imdb.com/search/title?release_date=1960-01-01,1970-12-31&title_type=tv_series,mini_series&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre70_link = 'http://www.imdb.com/search/title?release_date=1970-01-01,1980-12-31&title_type=tv_series,mini_series&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        self.genre80_link = 'http://www.imdb.com/search/title?release_date=1980-01-01,1990-12-31&title_type=tv_series,mini_series&release_date=,date[0]&genres=%s&sort=moviemeter,asc&count=40&start=1'
        ...
        self.language_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&num_votes=100,&production_status=released&primary_language=%s&sort=moviemeter,asc&count=40&start=1'
        self.certification_link = 'http://www.imdb.com/search/title?release_date=1950-01-01,1999-12-31&title_type=tv_series,mini_series&release_date=,date[0]&certificates=us:%s&sort=moviemeter,asc&count=40&start=1'
