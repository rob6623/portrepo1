...
if action == None:
    ...
    from resources.lib.indexers import movies
    movies.movies().genres50()
	
elif action == 'movieGenres60':
    from resources.lib.indexers import movies
    movies.movies().genres60()
	
elif action == 'movieGenres70':
    from resources.lib.indexers import movies
    movies.movies().genres70()
	
elif action == 'movieGenres80':
    from resources.lib.indexers import movies
    movies.movies().genres80()

elif action == 'tvGenres50':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genres50()
    ...
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genres60()


elif action == 'tvGenres70':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genres70()

elif action == 'tvGenres80':
    from resources.lib.indexers import tvshows
    tvshows.tvshows().genres80()
