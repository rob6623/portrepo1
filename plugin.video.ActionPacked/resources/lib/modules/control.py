...
"""
    //ActionPacked Add-on//
    Updated for ActionPacked Add-on
...
def metaFile():
    if condVisibility('System.HasAddon(script.ActionPacked.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.ActionPacked.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
