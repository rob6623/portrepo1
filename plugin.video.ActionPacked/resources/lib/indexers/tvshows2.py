...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Movies Watchlist', 'movieFavourites', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('TV Shows Watchlist', 'tvFavourites', 'movies.png', 'DefaultMovies.png')
    ...
    def mymovies(self):
        self.addDirectoryItem(movielist1, 'movies&url=mycustomlist1', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist2, 'movies&url=mycustomlist2', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist3, 'movies&url=mycustomlist3', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist4, 'movies&url=mycustomlist4', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist5, 'movies&url=mycustomlist5', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist6, 'movies&url=mycustomlist6', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist7, 'movies&url=mycustomlist7', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist8, 'movies&url=mycustomlist8', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist9, 'movies&url=mycustomlist9', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(movielist10, 'movies&url=mycustomlist10', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def mytv(self):
        ...
        self.addDirectoryItem(tvlist10, 'tvshows&url=mycustomlist10', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def kidstvCollections(self):
        self.addDirectoryItem('Animation Station', 'links2&url=tmdbanimationtv', 'lego.png', 'DefaultTVShows.png')
        ...
        self.addDirectoryItem('coming soon', 'tvshows&url=tmdbcoming', 'lil.png', 'DefaultTVShows.png')
        self.endDirectory()
