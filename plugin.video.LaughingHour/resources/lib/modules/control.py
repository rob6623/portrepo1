...
"""
    //LaughingHour Add-on//
    Updated for LaughingHour Add-on
...
def metaFile():
    if condVisibility('System.HasAddon(script.LaughingHour.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.LaughingHour.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
