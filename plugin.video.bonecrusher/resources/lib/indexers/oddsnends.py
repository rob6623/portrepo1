...
#       self.addDirectoryItem(32574, 'metalNavigator', 'Rock.png', 'decepticons.png')
        ...
        self.addDirectoryItem(32540, 'usersNavigator', 'Users requests.png', 'decepticons.png')
    ...
    def users(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('Sci fi tv shows', 'tvshows&url=tmdbScfinew', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('Sci fi movies', 'movies2&url=tmdbScfinew', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('User Requested Tv Shows Comedy', 'tvshows&url=tmdbcom1', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('User Requested Movies Comedy', 'movies2&url=tmdbcom1', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('christmas Movies ', 'movies2&url=tmdbxmas', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('Super Heroes  Movies ', 'movies2&url=tmdbsuper', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('Super Heroes tv shows ', 'tvshows&url=tmdbsuper', 'Users requests.png', 'decepticons.png')
        self.endDirectory()
