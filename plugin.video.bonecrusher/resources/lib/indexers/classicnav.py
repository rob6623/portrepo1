...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem(32584, 'action2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32585, 'adventure2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32586, 'animation2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32587, 'comedy2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32588, 'crime2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32589, 'drama2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32590, 'family2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32591, 'fantasy2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32592, 'horror2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32593, 'mystery2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32594, 'romance2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32595, 'scifi2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32596, 'thriller2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32597, 'war2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem(32598, 'western2Navigator', 'classics.png', 'DefaultMovies.png')
