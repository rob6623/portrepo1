...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem(32008, 'toolNavigator', 'genres.png', 'DefaultAddonProgram.png')
    ...
    def moviesdrama(self, lite=False):
        ...
        self.addDirectoryItem(32018, 'movies&url=populardrama', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32019, 'movies&url=viewsdrama', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32020, 'movies&url=boxofficedrama', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32021, 'movies&url=oscarsdrama', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32022, 'movies&url=theatersdrama', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def moviesrom(self, lite=False):
        ...
        self.addDirectoryItem(32017, 'movies&url=trendingrom', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32018, 'movies&url=popularrom', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32019, 'movies&url=viewsrom', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32020, 'movies&url=boxofficerom', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32021, 'movies&url=oscarsrom', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32022, 'movies&url=theatersrom', 'movies.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def tvshowsdrama(self, lite=False):
        ...
        self.addDirectoryItem(32018, 'tvshows&url=populardrama', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32023, 'tvshows&url=ratingdrama', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32019, 'tvshows&url=viewsdrama', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32024, 'tvshows&url=airingdrama', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32026, 'tvshows&url=premieredrama', 'tvshows.png', 'DefaultTVShows.png')
        self.endDirectory()
    ...
    def tvshowsrom(self, lite=False):
        ...
        self.addDirectoryItem(32017, 'tvshows&url=trendingrom', 'tvshows.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem(32018, 'tvshows&url=popularrom', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32023, 'tvshows&url=ratingrom', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32019, 'tvshows&url=viewsrom', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32024, 'tvshows&url=airingrom', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32026, 'tvshows&url=premiererom', 'tvshows.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32044, 'openSettings&query=3.1', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32045, 'openSettings&query=1.0', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32046, 'openSettings&query=6.0', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32047, 'openSettings&query=2.0', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32556, 'libraryNavigator', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32048, 'openSettings&query=5.0', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32049, 'viewsNavigator', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32050, 'clearSources', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32604, 'clearCacheSearch', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32052, 'clearCache', 'genres.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32073, 'authTrakt', 'trakt.png', 'DefaultAddonProgram.png')

        self.endDirectory()

    def library(self):
        self.addDirectoryItem(32557, 'openSettings&query=4.0', 'genres.png', 'DefaultAddonProgram.png')
