...
def metaFile():
    if condVisibility('System.HasAddon(script.Darklove.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.Darklove.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
