    ...
    def __init__(self):
        ...
        if self.infos:
            ...
            for key, value in iter(sorted(movie_items.iteritems())):
                ...
                li.setProperty('fanart_image', "special://home/addons/script.SKI/resources/skins/Default/media/%s-fanart.jpg" % image_code)
                if SCRIPT == "true" and "yt" not in value: url = 'plugin://script.SKI?info=%s&type=script' % key
                else: url = 'plugin://script.SKI?info=%s' % key
