...
class Main:
    ...
    def __init__(self):
        ...
        xbmc.executebuiltin('SetProperty(interdimensional_running,True,home)')
        ...
        if self.infos:
            ...
            for key, value in iter(sorted(movie_items.iteritems())):
                ...
                li.setProperty('fanart_image', "special://home/addons/script.interdimensional/resources/skins/Default/media/%s-fanart.jpg" % image_code)
                if SCRIPT == "true" and "yt" not in value: url = 'plugin://script.interdimensional?info=%s&type=script' % key
                else: url = 'plugin://script.interdimensional?info=%s' % key
        ...
        xbmc.executebuiltin('ClearProperty(interdimensional_running,home)')
