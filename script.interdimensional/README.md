...
Example:
<content>plugin://script.interdimensional?info=discography&amp;artistname=INSERT_ARTIST_NAME_HERE</content>
- keep Attention to the parameter separators: "&amp;" some places it may need to be "&"
Make your own custom commands:
- RunScript(script.interdimensional,argument1=value1,argument2=value2)
- RunPlugin(plugin://script.interdimensional/?argument1=value1&argument2=value2)
- ActivateWindow(Videos,plugin://script.interdimensional/?argument1=value1&argument2=value2,return)

### Custom (added by OpenELEQ)

RunScript(script.interdimensional,info=list,type=movie)     --> Starts script with movie-type
...
RunScript(script.interdimensional,info=list,type=tv)        --> Starts script with tv-type
  - optional additional parameter: query=
    - set query to "qqqqq" to force keyboard
  - optional additional parameter: iquery=              --> Executes custom iSearch using tv-list (~/resources/extras/tv/favourites.xml)
    - set iquery to "qqqqq" to force keyboard

RunScript(script.interdimensional,info=list,iquery=)        --> Executes custom iSearch using total list (~/resources/extras/total/favourites.xml)
  - set iquery to "qqqqq" to force keyboard

RunScript(script.interdimensional,info=list,type=channel)   --> Starts youtube-browser with channel-type
  - optional additional parameter: query=

RunScript(script.interdimensional,info=list,type=playlist)  --> Starts youtube-browser with playlist-type
  - optional additional parameter: query=

RunScript(script.interdimensional,info=list,type=video)     --> Starts youtube-browser with video-type
  - optional additional parameter: query=

RunScript(script.interdimensional,info=list,listid=)        --> Starts script using listid
  - TMDb login required

RunScript(script.interdimensional,info=string)              --> Sets SkinString (TotalSearch) and refreshes container
...
RunScript(script.interdimensional,info=zmovies)             --> All Movies in Script GUI
  - optional additional parameter: query=
...
RunScript(script.interdimensional,info=incinemas)           --> InCinemasMovies.%d
RunScript(script.interdimensional,info=upcoming)            --> UpcomingMovies.%d
RunScript(script.interdimensional,info=popularmovies)       --> PopularMovies.%d
RunScript(script.interdimensional,info=topratedmovies)      --> TopRatedMovies.%d
RunScript(script.interdimensional,info=similarmovies)       --> SimilarMovies.%d
  - required additional parameters: dbid=
RunScript(script.interdimensional,info=set)                 --> MovieSetItems.%d
- fetches a list of movies from the same Set
  - required additional parameters: dbid=
RunScript(script.interdimensional,info=directormovies)      --> DirectorMovies.%d
  - required additional parameters: director=
RunScript(script.interdimensional,info=writermovies)        --> WriterMovies.%d
  - required additional parameters: writer=
RunScript(script.interdimensional,info=studio)              --> StudioInfo.%d
...
RunScript(script.interdimensional,info=ztvshows)            --> All TVShows in Script GUI
  - optional additional parameter: query=
...
RunScript(script.interdimensional,info=populartvshows)      --> PopularTVShows.%d
RunScript(script.interdimensional,info=topratedtvshows)     --> TopRatedTVShows.%d
RunScript(script.interdimensional,info=onairtvshows)        --> OnAirTVShows.%d
RunScript(script.interdimensional,info=airingtodaytvshows)  --> AiringTodayTVShows.%d
...
### Trakt.tv
RunScript(script.interdimensional,info=trendingmovies)      --> TrendingMovies.%d
RunScript(script.interdimensional,info=similarmoviestrakt)  --> SimilarMovies.%d
...
RunScript(script.interdimensional,info=trendingshows)         --> TrendingShows.%d
RunScript(script.interdimensional,info=similartvshowstrakt)   --> SimilarTVShows.%d
...
RunScript(script.interdimensional,info=airingshows)         --> AiringShows.%d
RunScript(script.interdimensional,info=premiereshows)       --> PremiereShows.%d
...
### TheAudioDB
RunScript(script.interdimensional,info=discography)         --> Discography.%d
...
RunScript(script.interdimensional,info=mostlovedtracks)         --> MostLovedTracks.%d
- fetches most loved tracks for the given artist (TheAudioDB)
  - required additional parameters: artistname=
RunScript(script.interdimensional,info=albuminfo)               --> TrackInfo.%d
...
RunScript(script.interdimensional,info=artistdetails) ???

### LastFM
RunScript(script.interdimensional,info=albumshouts)
- fetches twitter shouts for given album
  - required additional parameters: artistname=, albumname=
RunScript(script.interdimensional,info=artistshouts)
...
RunScript(script.interdimensional,info=topartists)
- fetches a lists of the most popular artists
RunScript(script.interdimensional,info=hypedartists)
...
RunScript(script.interdimensional,info=nearevents)       --> NearEvents.%d
...
### YouTube
RunScript(script.interdimensional,info=youtubesearch)           --> YoutubeSearch.%d
  - required additional parameters: id=
RunScript(script.interdimensional,info=youtubeplaylist)         --> YoutubePlaylist.%d
  - required additional parameters: id=
RunScript(script.interdimensional,info=youtubeusersearch)       --> YoutubeUserSearch.%d
  - required additional parameters: id=
...
### Misc Images
RunScript(script.interdimensional,info=xkcd)                   --> XKCD.%d
- fetches a daily random list of XKCD webcomics
RunScript(script.interdimensional,info=cyanide)                --> CyanideHappiness.%d
- fetches a daily random list of Cyanide & Happiness webcomics
RunScript(script.interdimensional,info=dailybabe)              --> DailyBabe.%d
RunScript(script.interdimensional,info=dailybabes)             --> DailyBabes.%d
...
RunScript(script.interdimensional,info=extendedactorinfo,name=ACTORNAME)
RunScript(script.interdimensional,info=extendedactorinfo,id=ACTOR_TMDB_ID)

possible script calls for Movie Info Dialog:
RunScript(script.interdimensional,info=interdimensional,name=MOVIENAME)
RunScript(script.interdimensional,info=interdimensional,id=MOVIE_TMDB_ID)
RunScript(script.interdimensional,info=interdimensional,dbid=MOVIE_DBID)
RunScript(script.interdimensional,info=interdimensional,imdb_id=IMDB_ID)
...
#### List of Built In Controls for add-on dialogs :
 - MOVIES, TVSHOWS, SEASONS, EPISODES: script.interdimensional-DialogVideoInfo.xml
 - ACTORS: script.interdimensional-DialogInfo.xml
...
#### Labels Available In script.interdimensional-DialogInfo.xml:
...
#### Labels Available In script.interdimensional-DialogVideoInfo.xml:
