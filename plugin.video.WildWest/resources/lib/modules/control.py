...
def metaFile():
    if condVisibility('System.HasAddon(script.WildWest.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.WildWest.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
