...
class navigator:
    def root(self):
        ...
        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem(32003, 'mymovieNavigator', 'movies.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32004, 'mytvNavigator', 'tvshows.png', 'DefaultVideoPlaylists.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('Resistance Classic Westerns', 'movies&url=classwest', 'genres.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(32014, 'movieLanguages', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32015, 'movieCertificates', 'movies.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(32005, 'movieWidget', 'movies.png', 'DefaultRecentlyAddedMovies.png')

        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem(32003, 'mymovieliteNavigator', 'movies.png', 'DefaultVideoPlaylists.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem(32014, 'tvLanguages', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32015, 'tvCertificates', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32017, 'tvshows&url=trending', 'tvshows.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem(32018, 'tvshows&url=popular', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32023, 'tvshows&url=rating', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32019, 'tvshows&url=views', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32024, 'tvshows&url=airing', 'tvshows.png', 'DefaultTVShows.png')
        #self.addDirectoryItem(32025, 'tvshows&url=active', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32026, 'tvshows&url=premiere', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32006, 'calendar&url=added', 'tvshows.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
        self.addDirectoryItem(32027, 'calendars', 'tvshows.png', 'DefaultRecentlyAddedEpisodes.png')

        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem(32004, 'mytvliteNavigator', 'tvshows.png', 'DefaultVideoPlaylists.png')
