...
from bc_commons import cleantitle_get
...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.astroplane.container.items'

        self.metaProperty = 'plugin.video.astroplane.container.meta'
        ...
        self.blacklist_zips = ['.zip', '.jpeg', '.img', '.jpg', '.ZIP', '.jpg' , '.sub', '.srt']
