    ...
    def _inside_root(self):
        with self.lock:
            ...
            for links in self.items:
                ...
                print ("Nightmare QUALITY", links['quality'])
                quality = str(links['quality'])

                if "k" in quality.lower():  q_icon = "4k.jpg"
                if "1080" in quality:  q_icon = "1080.jpg"
                elif "HD" in quality: q_icon = "720.jpg"
                else: q_icon = "sd.jpg"

                # if self.providers_name.lower() == 'kat': q_icon = "kat.jpg"
                # if self.providers_name.lower() == 'thepiratebay': q_icon = "thepiratebay.jpg"
                # if self.providers_name.lower() == 'yify': q_icon = "yify.jpg"
                # if self.providers_name.lower() == 'leetx': q_icon = "leetx.jpg"
                # if self.providers_name.lower() == 'idope': q_icon = "idope.jpg"
                # if self.providers_name.lower() == 'limetorrent': q_icon = "lime.jpg"
                # if self.providers_name.lower() == 'eztv': q_icon = "eztv.jpg"

                if "torrent" in str(links['source']): q_icon = "torrent.jpg"
                if quality == '4k' or quality == '4K':  q_icon = "4k.jpg"
                try: info = links['info']
                except: info = ""
                ...
                try:
                    pluginid = "plugin.video.astroplane"
