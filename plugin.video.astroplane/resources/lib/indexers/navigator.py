...
class navigator:
	...
	def movies(self, lite=False):
		self.addDirectoryItem('Franchise', 'FranchiseNavigator', 'movies.jpg', 'DefaultMovies.jpg')
		self.addDirectoryItem('Top Sci Fi Directors', 'namegenre', 'movies.jpg', 'DefaultMovies.jpg')
		self.addDirectoryItem('Anime', 'movies&url=scifidir', 'movies.jpg', 'DefaultMovies.jpg')
	...
	def Franchise(self, lite=False):
		self.addDirectoryItem('STARTREK', 'movies&url=STARTREK', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('STARWARS', 'movies&url=STARWARS', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THEOUTERLIMITS', 'movies&url=THEOUTERLIMITS', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THETWILIGHTZONE', 'movies&url=THETWILIGHTZONE', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('DOCTORWHO', 'movies&url=DOCTORWHO', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('BATTLESTARGALACTICA', 'movies&url=BATTLESTARGALACTICA', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('PLANETOFTHEAPES', 'movies&url=PLANETOFTHEAPES', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('STARGATE', 'movies&url=STARGATE', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('FLASHGORDON', 'movies&url=FLASHGORDON', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('BACKTOTHEFUTURE', 'movies&url=BACKTOTHEFUTURE', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THEXFILES', 'movies&url=THEXFILES', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('FIREFLY', 'movies&url=FIREFLY', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('GODZILLA', 'movies&url=GODZILLA', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THETERMINATOR', 'movies&url=THETERMINATOR', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('JURASSICPARK', 'movies&url=JURASSICPARK', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('BABYLON', 'movies&url=BABYLON', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('MADMAX', 'movies&url=MADMAX', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THEMATRIX', 'movies&url=THEMATRIX', 'genres.png', 'DefaultMovies.jpg')	
		self.endDirectory()


	def Franchisetv(self, lite=False):
		self.addDirectoryItem('STARTREK', 'tvshows&url=STARTREK', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('STARWARS', 'tvshows&url=STARWARS', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THEOUTERLIMITS', 'tvshows&url=THEOUTERLIMITS', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THETWILIGHTZONE', 'tvshows&url=THETWILIGHTZONE', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('DOCTORWHO', 'tvshows&url=DOCTORWHO', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('BATTLESTARGALACTICA', 'tvshows&url=BATTLESTARGALACTICA', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('STARGATE', 'tvshows&url=STARGATE', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('FLASHGORDON', 'tvshows&url=FLASHGORDON', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THEXFILES', 'tvshows&url=THEXFILES', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('FIREFLY', 'tvshows&url=FIREFLY', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('THETERMINATOR', 'tvshows&url=THETERMINATOR', 'genres.png', 'DefaultMovies.jpg')
		self.addDirectoryItem('BABYLON', 'tvshows&url=BABYLON', 'genres.png', 'DefaultMovies.jpg')
		self.endDirectory()	
	...
	def tvshows(self, lite=False):
		self.addDirectoryItem('Franchise', 'tvFranchiseNavigator', 'tvshows.jpg', 'DefaultMovies.jpg')
		self.addDirectoryItem('Anime', 'tvshows&url=anime', 'tvshows.jpg', 'DefaultMovies.jpg')
