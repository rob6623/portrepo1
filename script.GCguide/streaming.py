...
class StreamsService(object):
    def __init__(self, addon):
        self.addon = addon
        path = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.GCguide', 'addons.ini'))
        xbmc.log('[script.GCguide] addons.ini is used', xbmc.LOGDEBUG)
