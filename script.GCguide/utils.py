...
def folder():
	ivuedirectcry = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.GCguide'))
...
def addons(shortcut=None):
    ...
    if not shortcut: 
        shortcut = ''
        resp = dialog.select('[COLOR fffea800]Gas Chamber Default Shortcuts[/COLOR]', ['BBC iPlayer', 'ITV player', 'Project D', 'Skynet', 'Covenant', 'Specto', 'Youtube', 'WolfPack', 'Supremacy', 'Picasso'])
    if resp == 0 or shortcut ==1:
        title = 'BBC iPlayer'
        image = 'special://home/addons/script.GCguide/resources/png/bbc icon.png'
    ...
    if resp == 1 or shortcut ==2:
        title = 'ITV Player'
        image = 'special://home/addons/script.GCguide/resources/png/itv icon.png'
    ...
    if resp == 2 or shortcut ==3:
        title = 'Project D'
        image = 'special://home/addons/script.GCguide/resources/png/projectd.png'
    ...
    if resp == 3 or shortcut ==4:
        title = 'Skynet'
        image = 'special://home/addons/script.GCguide/resources/png/skynet.png'
    ...
    if resp == 4 or shortcut ==5:
        title = 'Covenant'
        image = 'special://home/addons/script.GCguide/resources/png/Covenant.png'
    ...
    if resp == 5 or shortcut ==6:
        title = 'Specto'
        image = 'special://home/addons/script.GCguide/resources/png/specto icon.png'
    ...
    if resp == 6 or shortcut ==7:
        title = 'Youtube'
        image = 'special://home/addons/script.GCguide/resources/png/youtube.png'
    ...
    if resp == 7 or shortcut ==8:
        title = 'WolfPack'
        image = 'special://home/addons/script.GCguide/resources/png/wolfpack.png'
    ...
    if resp == 8 or shortcut ==9:
        title = 'Supremacy'
        image = 'special://home/addons/script.GCguide/resources/png/supremacy.png'
    ...
    if resp == 9 or shortcut ==10:
        title = 'Picasso'
        image = 'special://home/addons/script.GCguide/resources/png/picasso.png'
