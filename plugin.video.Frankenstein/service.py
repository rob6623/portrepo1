...
def syncTraktLibrary():
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.Frankenstein/?action=tvshowsToLibrarySilent&url=traktcollection')
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.Frankenstein/?action=moviesToLibrarySilent&url=traktcollection')
...
try:
    ...
    #log_utils.log('### Frankenstein REPOSITORY VERSION: %s ###' % str(RepoVersion), log_utils.LOGNOTICE)
